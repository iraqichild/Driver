...
/*
   {
      "Address": 228575416,
      "Name": "BasePlayer.%74261b1f8c742f36802b282b887580893c7365c0_TypeInfo",
      "Signature": "BasePlayer__74261b1f8c742f36802b282b887580893c7365c0_c*"
    },
*/

int main()
{
    Driver* ctx = new Driver;
    ctx->OpenHandle();
    ctx->Attach(L"cs2.exe");
    uint64_t base = ctx->GetModuleBaseAddress(L"GameAssembly.dll");
